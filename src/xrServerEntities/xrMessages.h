...
enum
{
	...
	GE_ACTOR_ANIMATION_MOTIONID,
	GE_ACTOR_ITEM_ACTIVATE,
	GE_ACTOR_SND_ACTIVATE,

	//INV_BOX
	GE_INV_BOX_PRIVATE_SAFE,

	//PDA MP System
	GE_PDA_SQUAD_SEND_INVITE,
	GE_PDA_SQUAD_CANCEL_INVITE,
	GE_PDA_SQUAD_RESPOND_INVITE,
	GE_PDA_SQUAD_KICK_PLAYER,
	GE_PDA_SQUAD_MAKE_LEADER,
