...
#	define INHERIT_ABSTRACT \
		...
		DEFINE_LUA_WRAPPER_METHOD_R2P1_V2	(STATE_Read,	NET_Packet,	u16)\
		DEFINE_LUA_WRAPPER_METHOD_0			(init,			CSE_Abstract*)\
 		DEFINE_LUA_WRAPPER_METHOD_R2P1_V1	(UPDATE_WriteScript, NET_Packet)\
		DEFINE_LUA_WRAPPER_METHOD_R2P1_V1	(UPDATE_ReadScript, NET_Packet)\
		DEFINE_LUA_WRAPPER_METHOD_V0		(update_CL) 
