...
enum EGamePlayerFlags
{
	...
	GAME_PLAYER_MP_NO_CLIP				= (1<<9),
	GAME_PLAYER_MP_INVIS				= (1<<10),
	GAME_PLAYER_MP_GOD_MODE				= (1<<11),
	GAME_PLAYER_MP_SAFE_MODE			= (1 << 12),
	GAME_PLAYER_MP_ANIM_MODE			= (1 << 13),
	GAME_PLAYER_MP_ON_CONNECTED			= (1 << 14),
	GAME_PLAYER_MP_SAVETEAM				= (1 << 15),
	GAME_PLAYER_MP_UNLIMATED_AMMO		= (1 << 16),
