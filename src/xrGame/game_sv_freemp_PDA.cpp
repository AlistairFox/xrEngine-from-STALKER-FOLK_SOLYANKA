...
//PDA Contacts (Криво смотреть нужно (лучше сделать через getClientID(сразу регать в списке)
// как павел сделал в войсе для игроков ) )
// Разберусь потом когда свет будет
