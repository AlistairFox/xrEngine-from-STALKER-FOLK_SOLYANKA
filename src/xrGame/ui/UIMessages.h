...
enum EUIMessages
{
	...
	TALK_DIALOG_ART_UPGRADE_BUTTON_CLICKED,
	...
	INVENTORY_REPAIR,
	INVENTORY_CAMPSWITCH,
	INVENTORY_GIFT_ITEM,
	INVENTORY_INJECT_ITEM,
	...
	// DEAD EDGE PDA MP SYSTEM CONTACTS  (Не допилено)
	PDA_PROPERTY_ADD_TO_SQUAD,
	PDA_PROPERTY_ADD_TO_CHAT,

	PDA_PROPERTY_REMOVE_USER, 
	PDA_PROPERTY_SET_LEAD,
	PDA_PROPERTY_EXIT_SQUAD,
	PDA_PROPERTY_REMOVE_SQUAD,

	//PDA MP SYSTEM		(XRMPE)
	UI_PDA_SQUAD_SEND_INVITE,
	UI_PDA_SQUAD_CANCEL_INVITE,
	UI_PDA_SQUAD_ACCEPT_INVITE,
	UI_PDA_SQUAD_DECLINE_INVITE,
	UI_PDA_SQUAD_MAKE_LEADER,
	UI_PDA_SQUAD_KICK_PLAYER,
