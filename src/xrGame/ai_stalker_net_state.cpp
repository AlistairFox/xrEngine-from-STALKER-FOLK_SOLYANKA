...
float char4_to_float(u8 value) //0.0666 //4 bit (ÒÎÊ ÄË‗ FLOAT 0.f->1.f)
{
	return value / 15.0f;
}

u8 float_to_char8(float value) //0.0039 //8bit (ÒÎÊ ÄË‗ FLOAT 0.f->1.f)
{
	if (value > 1.0f)
		value = 1.0f;
...
float char8_to_float(u8 value) //0.0039 //8 bit (ÒÎÊ ÄË‗ FLOAT 0.f->1.f)
{
	return  value / 255.0f ;
}
