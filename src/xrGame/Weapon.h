...
{
public:
	bool static GetUseHQ_Icons() { return false; };
	bool static GetOGSE_WpnZoomSystem() { return false; }
	bool static GetUse3dScope() { return false; }
	bool static GetReloadIfSprint() { return true; }
	bool static GetStopActorIfShoot() { return false; }
	bool static GetPNV_W_SCOPE_DIS() { return false; } //AF_PNV_W_SCOPE_DIS
};
...
public:
	...
	virtual void			WriteUpdateActiveSlot(NET_Packet& P);
	virtual void			OnUpdateActiveSlot(NET_Packet& P);
...
public:
	...
	virtual CObject* ObjectParrent() { return H_Parent(); }
