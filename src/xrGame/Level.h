...
public:
	...
	virtual void				OnStatsNetwork(CGameFont* F);
...
enum EGameFlags
{
	...
	F_SPECTATOR_MOVEMENT_DISABLED,
	F_SPECTATOR_ROTATION_DISABLED,
	
	F_ITEMS_AUTO_PICKUP_DISABLED,

	F_MUTANTS_DEADBODY_SEARCH_ENABLED,

	F_ZONES_ALWAYS_FAST_MODE,
