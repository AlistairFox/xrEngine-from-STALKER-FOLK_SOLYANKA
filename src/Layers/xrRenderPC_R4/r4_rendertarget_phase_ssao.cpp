...
extern float			hbao_plus_radius;
extern float			hbao_plus_bias;
extern float hbao_plus_power_exponent;
extern float hbao_plus_blur_sharp;
...
void CRenderTarget::phase_hbao_plus()
{
	...
	Params.Radius = hbao_plus_radius;
	Params.Bias = hbao_plus_bias;
	Params.PowerExponent = hbao_plus_power_exponent;
	Params.Blur.Enable = true;
	Params.Blur.Radius = GFSDK_SSAO_BLUR_RADIUS_4;
	Params.Blur.Sharpness = hbao_plus_blur_sharp;
