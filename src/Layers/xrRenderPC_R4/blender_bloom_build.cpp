...
void	CBlender_bloom_build::Compile			(CBlender_Compile& C)
{
	...
	case 0:		// transfer into bloom-target
		C.r_Pass			("stub_notransform_build","bloom_build",	false,	false,	false, false, D3D11_BLEND_SRC_ALPHA, D3D11_BLEND_INV_SRC_ALPHA);
...
void	CBlender_postprocess_msaa::Compile			(CBlender_Compile& C)
{
	...
	{
	case 0:		// transfer into bloom-target
		C.r_Pass			("stub_notransform_postpr","postprocess",	false,	false,	false, false, D3D11_BLEND_SRC_ALPHA, D3D11_BLEND_INV_SRC_ALPHA);
	...
	case 4:		// use color map
		C.r_Pass			("stub_notransform_postpr","postprocess_CM",	false,	false,	false, false, D3D11_BLEND_SRC_ALPHA, D3D11_BLEND_INV_SRC_ALPHA);
		C.r_dx10Texture		("s_base0",	r2_RT_generic);
		C.r_dx10Texture		("s_base1",	r2_RT_generic);
		C.r_dx10Texture		("s_noise", "fx\\fx_noise2");
