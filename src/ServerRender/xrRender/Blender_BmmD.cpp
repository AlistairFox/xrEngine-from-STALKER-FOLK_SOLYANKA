...
void	CBlender_BmmD::Compile	(CBlender_Compile& C)
{
	...
	case SE_R2_NORMAL_LQ: 		// deffer
		...
		C.r_Stencil(false, D3D11_COMPARISON_ALWAYS, 0xff, 0x7f, D3D11_STENCIL_OP_KEEP, D3D11_STENCIL_OP_REPLACE, D3D11_STENCIL_OP_KEEP);
		C.r_StencilRef	(0x01);
	...
	case SE_R2_SHADOW:			// smap
		...
		C.r_Pass	("shadow_direct_base","dumb",	false,false,false,false);
		//C.r_Sampler		("s_base",C.L_textures[0]);
