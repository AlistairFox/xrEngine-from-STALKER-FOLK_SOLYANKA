...
struct ImGuiTableSortSpecs
{
    ...
    ImGuiTableSortSpecs();// { SecureZeroMemory(this, sizeof(this)); }
};
...
struct ImGuiTableColumnSortSpecs
{
    ...
    ImGuiTableColumnSortSpecs();// { SecureZeroMemory(this, sizeof(*this)); }
};
...
struct ImGuiPayload
{
    ...
    {
        return DataFrameCount != -1 && std::string(type) == std::string(DataType);
    }
